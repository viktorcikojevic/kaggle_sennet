...
parhs=["/opt/kaggle/sennet/data/blood-vessel-segmentation/train/kidney_1_dense"]
for i,path in enumerate(parhs):
    if path=="/opt/kaggle/sennet/data/blood-vessel-segmentation/train/kidney_3_dense":
        continue
...
path1="/opt/kaggle/sennet/data/blood-vessel-segmentation/train/kidney_3_sparse"
path2="/opt/kaggle/sennet/data/blood-vessel-segmentation/train/kidney_3_dense"
...
wandb.init(project="three_d_seg", name=f"best-kaggle-{CFG.backbone}-{CFG.epochs}-{time_now}")
...
# log to wandb
wandb.log({"train_loss": losss, "train_score": scores, "val_loss": val_losss, "val_score": val_scores})
